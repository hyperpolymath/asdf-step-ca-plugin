...
:url-repo: https://github.com/hyperpolymath/asdf-step-ca-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-step-ca-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-step-ca-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-step-ca-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Step Ca] versions.
...
Step Ca is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Step Ca versions per project

|**Project Isolation**
|Pin Step Ca per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Step Ca version
...
=== Installing Step Ca Versions

[source,bash]
----
asdf list all step-ca
asdf install step-ca latest
asdf install step-ca 0.1.0
----
...
[source,bash]
----
asdf global step-ca 0.1.0
asdf local step-ca 0.1.0
asdf current step-ca
step-ca --version
----
...
* Ensure `step-ca` is on PATH after installation.
* Verify the installed version with `step-ca --version`.
